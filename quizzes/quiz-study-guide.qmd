...
Quiz 2 will test the following learning objectives, divided into 5 topic areas. For each topic area, you should be able to do the list that follows. You can think of this as a studying checklist!
...
1. **Probability distributions**
    - Explore a dataset with a histogram and descriptive statistics
