...
|-|--|-------|
| **4** | **Exceptional!** | You understand the course material deeply and can do all parts of this problem yourself with no mistakes. |
| **3** | **Well done!** | You understand the course material and can do all parts of this problem yourself with very few mistakes. |
| **2** | **Getting there** | You understand the course material to some extent and can do some parts of this problem, but you need a little more practice to get there. |
| **1** | **Just starting** | You have lots of gaps in your understanding of the course material and could not do most of this problem. You need a lot more practice to get there. |
