...
|-|-|--|-------|
| **4** | 100% | **Exceptional!** | You understand the course material deeply and can do all parts of this problem yourself with no mistakes. |
| **3** | 90% | **Well done!** | You understand the course material and can do all parts of this problem yourself with very few mistakes. |
| **2** | 80% | **Getting there** | You understand the course material to some extent and can do some parts of this problem, but you need a little more practice to get there. |
